...
const SocialBar = () => {
    ...
    return (
        <div className='social-media' style={!socialMediaIsOpen ? {transform: 'translate(70%, -50%)'} : {transform: 'translate(0, -50%)'}}>
            <ul>
                <li><a href="https://github.com/OlivierPire" target='_blank' rel="noreferrer"><img src={githubLogo} alt="" className='media' /></a></li>
                <li><a href="https://www.linkedin.com/in/olivier-pire" target='_blank' rel="noreferrer"><img src={linkedinLogo} alt="" className='media' /></a></li>
